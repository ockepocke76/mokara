...
def configure_logging():
    ...
    # --- FIX: Clear any existing handlers to prevent duplicate logging ---
    # This is crucial for background processes that might re-initialize logging.
    ...
    noisy_loggers = [
        ...
        'choreo',  # Suppress verbose Choreo/Kaleido flowchart generation logs
        'kaleido'
    ]
